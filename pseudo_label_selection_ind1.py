...
FE_joint_weightpath = "./Feat_extractor_sepa1_pre.pth"
Clfier_joint_weightpath = "./Classifier_sepa1_pre.pth"
...
output_src1=torch.stack(output_src1)
...
scio.savemat('list_s1_src1.mat', {'list_s1_src1':list_src1})
